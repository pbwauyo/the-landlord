package com.peter.thelandlord.presentation.ui.propertydetails
...
class PropertyDetails : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.addRentalCardView?.setOnClickListener{
            val action =
                PropertyDetailsDirections.actionPropertyDetailsToAddRental(
                    propertyID
                )
        ...
        binding?.rentalListCardView?.setOnClickListener {
            ...
            val action =
                PropertyDetailsDirections.actionPropertyDetailsToRentalsList(
                    propertyID
                )
            navController.navigate(action)
        }
