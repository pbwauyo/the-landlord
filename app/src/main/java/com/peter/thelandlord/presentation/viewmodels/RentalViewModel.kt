...
class RentalViewModel(val rentalManagementRepoImpl: RentalManagementRepoImpl): ViewModel() {
    ...
    fun getCurrentRentalId(): String?{
        return currentRentalIdLiveData.value
    }

    fun getCurrentPropertyId(): String?{
        return currentPropertyIdForRentalLiveData.value
    }
